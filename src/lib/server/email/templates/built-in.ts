 ...
 */
export const builtInTemplates: Record<EmailTemplateType, EmailTemplate> = {
...
{{/if}}
		`,
		requiredData: ['name', 'email', 'appName'],
		optionalData: ['dashboardUrl', 'unsubscribeUrl']
	},
...
{{appName}} - Keeping your account secure
		`,
		requiredData: ['name', 'email', 'resetLink', 'appName', 'expirationTime'],
		optionalData: []
	},
